...
class pts_timed_test_result_buffer
{
	public $buffer_items;
	...
	public function add_test_result($identifier, $value, $raw_value = null, $json = null, $min_value = null, $max_value = null, $start = null, $duration = null)
	{
		array_push($this->buffer_items, new pts_timed_test_result_buffer_item($identifier, $value, $raw_value, $json, $min_value, $max_value, $start,$duration));
	}
	...
	public function get_start_times()
	{
		...
		foreach($this->buffer_items as &$buffer_item)
		{
			array_push($values, $buffer_item->get_result_start());
		}
	...
	public function get_duration_times()
	{
		...
		foreach($this->buffer_items as &$buffer_item)
		{
			array_push($values, $buffer_item->get_result_duration());
		}
